  ...
  <div class="navbar-collapse collapse navbar-responsive-collapse">
	...
	<div class="subnav scrollnav">
     <ul class="nav nav-pills">
	  ...
	  <li <?php if($_GET['content'] == 'home'){ ?> class="active" <?php } ?>><a href="index.php?content=home"><Strong>Home</Strong></a></li>
			
	  <li <?php if($_GET['content'] == 'leads' || $_GET['content'] == 'lead_edit'){ ?> class="active" <?php }
							else{?> class="dropdown" <?php } ?>>
							  <a href="#" class="dropdown-toggle" data-toggle="dropdown"><Strong>Leads</Strong><b class="caret"></b></a>
      ...
      <li <?php if($_GET['content'] == 'notifications'){ ?> class="active" <?php } ?>><a style="margin-top: 1px;" href="index.php?content=notifications"><Strong>Notifications <span class="badge"><?php print $notifs ?></span></Strong></a></li>

      <li <?php if($_GET['content'] == 'settings'){ ?> class="active" <?php } ?>><a href="index.php?content=settings"><Strong>Settings</Strong></a></li>
     
	  <?php if ($_SESSION['isAdmin']) { ?>
		<li <?php if($_GET['content'] == 'admin'){ ?> class="active" <?php } ?>><a href="index.php?content=admin"><Strong>Admin</Strong></a></li>
	  <?php } ?>
