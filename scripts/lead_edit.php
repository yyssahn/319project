		...
		<form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
			...
			<div class="jumbotron">
				...
				<div class="row">
					...
					<div class="col-md-4">
							<input type="text" class="form-control" id="phone" placeholder="Enter Valid Phone Number">
					</div>
				
					<label for="email" class="col-md-2 control-label">Contact Email:</label>
					<div class="col-md-4">
							<input type="email" class="form-control" id="email" placeholder="Enter Valid Email Address">
					</div>
				</div>
			</div>
			...
			<div class="jumbotron">
				<div class="row">
					...
					<div class="col-md-4">
							<input type="text" class="form-control" id="lead_name" placeholder="Enter a Name for the Lead">
					</div>
					
					<label for="description" class="col-md-2 control-label">Description:</label>
					<div class="col-md-4">
							<textarea class="form-control" id="description" rows="4" placeholder="Enter a Brief Description of the Lead"></textarea>
					</div>
				</div>
